  ...
  if(NOT GCOV_${CMAKE_${LANG}_COMPILER_ID}_BIN)
    ...
    elseif("${CMAKE_${LANG}_COMPILER_ID}" MATCHES "^(Apple)?Clang$")
      ...
      if(LLVM_VERSION VERSION_GREATER 3.4)
        find_program(LLVM_COV_BIN NAMES "llvm-cov-${LLVM_VERSION}" "llvm-cov" HINTS ${COMPILER_PATH})
        ...
        if(LLVM_COV_BIN)
          ...
          if(LLVM_COV_WRAPPER)
            ...
            set(GCOV_${CMAKE_${LANG}_COMPILER_ID}_ENV "LLVM_COV_BIN=${LLVM_COV_BIN}" CACHE STRING "Environment variables for llvm-cov-wrapper.")
      ...
      if(NOT GCOV_BIN)
        # Fall back to gcov binary if llvm-cov was not found or is incompatible. This is the default on OSX, but may crash on recent Linux versions.
    ...
    if(GCOV_BIN)
      ...
      if(NOT CMAKE_REQUIRED_QUIET)
        message("-- Found gcov evaluation for " "${CMAKE_${LANG}_COMPILER_ID}: ${GCOV_BIN}")
      endif()
...
# This function will add gcov evaluation for target <TNAME>. Only sources of this target will be evaluated and no dependencies will be added. It will call Gcov on any source file of <TNAME> once and
# store the gcov file in the same directory.
